...
public class FirstNameUtility {
    ...
    public int firstNameEncoder(String firstName, String middleInitial) throws MissingNameException {
        ...
        else if (!firstNameCodeMap.containsValue(firstName)){
            String middleInitialIndex = middleInitial.substring(0,1).toUpperCase();
            String firstInitialIndex = firstName.substring(0,1).toUpperCase();
        return firstInitialCodeMap.get(firstInitialIndex) + middleInitialCodeMap.get(middleInitialIndex);
        }
return 0;
    }
}
